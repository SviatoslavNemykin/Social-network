    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tags', models.ManyToManyField(related_name='tags', to='my_publications.tag')),
            ],
        ),
        migrations.CreateModel(
            name='Link',
            fields=[
                ...
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='links', to='my_publications.post')),
            ],
        ),
        migrations.CreateModel(
            name='PostImage',

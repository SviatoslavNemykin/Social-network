...
from .views import  FriendActionView, FriendsView, FriendsSectionView, UserFriendView
...
urlpatterns = [
    ...
    path("action/<int:user_id>/<str:action>/", FriendActionView.as_view(), name="friend_action")
]